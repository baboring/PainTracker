...
namespace HC {
    ...
    public static class Logger {
        ...
        [Conditional("CONDITIONAL_LOG")]
        public static void Debug(ColorType color, string logString) {
            WriteFileLog(logString, LogLevel.DEBUG);
            UnityEngine.Debug.Log(string.Format("<color={0}>{1}</color>", color.ToString(), logString));
        }
        [Conditional("CONDITIONAL_LOG")]
        ...
        public static void Warning(string logString) {
            WriteFileLog(logString, LogLevel.WARN);
            UnityEngine.Debug.Log(logString);
        }
        [Conditional("CONDITIONAL_LOG")]
        public static void WarningFormat(string szFormat, params object[] p) {
            WriteFileLog(string.Format(szFormat, p), LogLevel.WARN);
            UnityEngine.Debug.Log(string.Format(szFormat, p));
        }

        [Conditional("CONDITIONAL_LOG")]
        public static void Error(string szFormat, params object[] p) {
            WriteFileLog(GetErrorString(StackTracer(), szFormat, p), LogLevel.ERROR);
            UnityEngine.Debug.LogError(string.Format(szFormat, p));
        }

        [Conditional("CONDITIONAL_LOG")]
        public static void Fatal(string szFormat, params object[] p) {
        ...
        */
        ...
        [Conditional("CONDITIONAL_LOG")]
        public static void Assert(bool condition, string szFormat = null, params object[] p) {
